  ...
  return (
    <div className="resumesearch-container">
      ...
      <form className="resumesearch-form1" onClick={handleSelectResume}>
        <span className="resumesearch-text24">{responseRole_1}</span>
        <span className="resumesearch-text25">{responseMajor_1}</span>
        <span className="resumesearch-text26">{responseSkill_1}</span>
      </form>
      <form className="resumesearch-form2" onClick={handleSelectResume}>
        <span className="resumesearch-text27">{responseRole_2}</span>
        <span className="resumesearch-text28">{responseMajor_2}</span>
        <span className="resumesearch-text29">{responseSkill_2}</span>
      </form>
      <form className="resumesearch-form3" onClick={handleSelectResume}>
        <span className="resumesearch-text30">{responseRole_3}</span>
        <span className="resumesearch-text31">{responseMajor_3}</span>
        <span className="resumesearch-text32">{responseSkill_3}</span>
      </form>
    </div>
  )
}
