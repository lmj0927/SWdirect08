  ...
  return (
    <div className="join-container">
      ...
      <form className="join-form">
        ...
        <input type="password" className="join-textinput1 input" />
        <input type="text" className="join-birthdayinput input" placeholder='Ex) 990216' />
        <input type="text" className="join-univinput input" />
        <input type="password" className="join-textinput2 input" />
        <input type="text" className="join-textinput3 input" />
